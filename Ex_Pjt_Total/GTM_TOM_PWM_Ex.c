...
#define BLUE_LED_USER       IfxGtm_TOM0_2_TOUT104_P10_2_OUT         /* LED which will be driven by the PWM          */
...
void initGtmTomPwm(void)
{
    ...
    g_tomConfig.tom = BLUE_LED_USER.tom;                                      /* Select the TOM depending on the LED          */
    g_tomConfig.tomChannel = BLUE_LED_USER.channel;                           /* Select the channel depending on the LED      */
    g_tomConfig.period = PWM_PERIOD;                                /* Set the timer period                         */
    g_tomConfig.pin.outputPin = &BLUE_LED_USER;                               /* Set the LED port pin as output               */
